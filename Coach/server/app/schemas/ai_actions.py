# server/app/schemas/ai_actions.py
...
class AIProposal(BaseModel):
    ...
    """
    intent: Literal[
        "add_workout", "move_workout", "edit_workout", "upsert_sets", "delete_workout", "bulk_plan"
    ]
    payload: dict
    summary: str = ""
    confidence: float = Field(ge=0.0, le=1.0, default=0.7)
    requires_confirmation: bool = True
    requires_super_confirmation: bool = False  # set True for risky ops like delete/replace
